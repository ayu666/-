...
public class GcovCoverage {
	...
	public GcovCoverage(int ver,int tc,List<int[]> tcList,String object)
	{
		verNo = ver;
		tcNo = tc;
		tcMatrixs = tcList;
	...
	private boolean readTestcaseGcov(int ver,int tc,List<CovInfo> covInfolst)
	{
		...
		String gcovFile = ProjectConfiguration.DatasetDirectory +
				...
				"v"+String.valueOf(ver)+"/"+"t"+String.valueOf(tc)+".gcov";
